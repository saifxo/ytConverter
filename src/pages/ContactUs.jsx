...
const ContactUs = () => {
  return (
    <>
      <div class="container mt-32 mb-12 mx-auto px-2 md:px-4 ">
        <section class="mb-32">
          ...
          <div class="flex flex-wrap mt-12">
            <form class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <div class="mb-3 w-full">
                <label
                  class="block font-medium mb-[2px] text-blue-600"
              ...
              <button
                type="button"
                class="mb-6 inline-block w-full rounded bg-blue-600 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md  hover:bg-blue-800"
              >
                Send
              </button>
            </form>
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12  ">
              <div class="flex  gap-1 flex-col lg:flex-row w-full items-center justify-center">
                <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6 shadow-xl">
                  <div class="flex items-start">
                    <div class="shrink-0">
                      <div class="inline-block rounded-md bg-blue-600-100 p-4 text-blue-600">
                        <svg
